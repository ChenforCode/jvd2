...
import pku.jvd.deseri.core.collector.ClassInfoCollector;
import pku.jvd.deseri.core.container.DataContainer;
import pku.jvd.deseri.dal.caching.bean.edge.Alias;
import pku.jvd.deseri.dal.caching.bean.edge.Extend;
import pku.jvd.deseri.dal.caching.bean.edge.Has;
import pku.jvd.deseri.dal.caching.bean.edge.Interfaces;
...
public class ClassInfoScanner {
    private static final Log log = LogFactory.get(ClassInfoScanner.class);
    @Autowired
